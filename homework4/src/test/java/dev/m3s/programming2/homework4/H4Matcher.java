...
class H4Matcher<T> extends BaseMatcher<T> {
     ...
     */
    public H4Matcher(T expected, FailureMessage message) {
    ...
    private static <T> H4Matcher<T> not(T expected, FailureMessage message) {
        H4Matcher<T> matcher = new H4Matcher<>(expected, message,
    ...
    public static <T> void assertEquals(T actual, T expected,
        ...
        makeAssertion(actual, new H4Matcher<>(expected, message));
    }
    ...
    public static <T> void assertEquals(T actual, T expected,
        ...
        assertEquals(actual, expected, modifiedMessage);
    }
    ...
    public static void assertTrue(BooleanSupplier actual) {
        assertTrue(actual.getAsBoolean());
    }
    ...
    public static void assertFalse(boolean actual, String message) {
        FailureMessage modifiedMessage = explain(message);
        assertFalse(actual, modifiedMessage);
    }

    public static void assertFalse(BooleanSupplier actual) {
        assertFalse(actual.getAsBoolean());
    }
    ...
    public static void assertReturns(Object actual, Object expected,
        ...
        FailureMessage def = explain().expected(
                ...
                .but(methodName + " returned ⟨" + actual
                        + "⟩");
        makeAssertion(actual, new H4Matcher<>(expected, def.copyFrom(message)));
    }
    ...
    public static <T extends Number> void assertWithin(T actual,
        ...
        makeAssertion(expected.includes(actual),
                new H4Matcher<>(true, def.copyFrom(message)));
    }
    ...
    public static <T extends Number> void assertWithout(T actual,
        ...
        FailureMessage def = explain().expected(
                ...
                .but("was ⟨" + actual + "⟩");
        makeAssertion(expected.includes(actual),
                new H4Matcher<>(false, def.copyFrom(message)));
    }
    ...
    private static <T> void makeAssertion(T actual, H4Matcher<T> matcher) {
